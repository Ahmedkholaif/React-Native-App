...
export default class Example extends Component {
  ...
  _renderModalContent = () => (
    ...
    <View style={styles.modalContent}>
        ...
        Would you want to allow NASNAV to use Touch ID for your next login?
        </Text>
        </View>
  ...
  render() {
    return (
      <View style={styles.container}>
        {this._renderButton('touch A slower modal', () => this.setState({ visibleModal: 3 }))}
        {this._renderButton('touch Fancy modal!', () => this.setState({ visibleModal: 4 }))}
        <Modal
