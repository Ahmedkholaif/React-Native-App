...
export default class App extends Component {
  ...
  _renderItem = props => (
    <View
      style={[
        styles.mainContent,
        this.state.isPortrait ? styles.portraitMainContent : null
      ]}
    >
      <Image
        style={[
          props.imageStyle,
          !this.state.isPortrait ? styles.landscape_img : null
        ]}
        source={props.image}
      />
      <View>
      ...
      return (
        <AppIntroSlider
          ...
          activeDotStyle={[
            ...
            isPortrait ? styles.portraitDotStyle : null
          ]}
          dotStyle={[
            styles.dotStyle,
            isPortrait ? styles.portraitDotStyle : null
          ...
          buttonStyle={[
            styles.bottomButton,
            isPortrait ? styles.portraitBottomButton : null
          ]}
